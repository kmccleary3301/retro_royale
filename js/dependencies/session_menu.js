function session_menu() {
	this.setup = function() {
		...
		this.buttons["main"][2] = new button(75, 50, 100, 50, this.blue, [10, 10, 10], "back", 4, true, false);
		this.buttons["create_session"][0] = new button(860, 680, 150, 100, this.blue, [10, 10, 10], "start", 4, true, false);
		this.buttons["create_session"][1] = new button(1060, 680, 150, 100, this.blue, [10, 10, 10], "cancel", 4, true, false);
		this.buttons["join_session"][0] = new button(860, 680, 150, 100, this.blue, [10, 10, 10], "join", 4, true, false);
		this.buttons["join_session"][1] = new button(1060, 680, 150, 100, this.blue, [10, 10, 10], "cancel", 4, true, false);
		g_cam.reset();
	}
	...
	this.adjust_current_menu = function() {
		...
		for (let i in this.buttons[this.current_menu]) {
			if (this.current_menu == "main_menu" && i == 2) { continue; }
	...
	this.draw_menu_1 = function() {
		...
		text_make(4, Math.min(110*height/1080, 110*width/1920), 0, 2);
	...
	this.button_press = function(code) {
		if (this.current_menu == "main") {
			switch(int(code)) {
				case 0:
					this.create_menu_enable(); 
					break;
				case 1:
					this.join_menu_enable();
					break;
				case 2:
					socket.close();
			...
			switch(int(code)) {
				case 0:
					this.create_session_send();
					break;
				case 1:
					this.create_menu_disable();
					break;
			}
		} else if (this.current_menu == "join_session") {
			switch(int(code)) {
				case 0:
					this.join_session_send();
					break;
				case 1:
					this.join_menu_disable();
					break;
			}
		}
	}
